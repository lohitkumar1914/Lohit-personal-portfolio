  ...
  return (
    <section id="hero">
      <div className="pb-12 sm:pb-20 pt-24 sm:pt-32 h-auto">
         ...
         */}
        <div
          className="h-[40vh] w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.03] bg-grid-black-100/[0.2]
        ...
        <div className="flex justify-center relative my-4 sm:my-8 z-10">
          <div className="max-w-[95vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            ...
            <div className="flex justify-center space-x-2 sm:space-x-4">
              ...
              <a href="/lohit_CV.pdf" target="_blank" rel="noopener noreferrer">
                <MagicButton
                  title="Resume"
                  icon={<FaDownload />}
                  position="right"
